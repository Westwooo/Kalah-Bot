...
public class Protocol {
     ...
     * @see #getMessageType(String)
     */
    public static MoveTurn interpretStateMsg(String msg, Board board, Side mySide) throws InvalidMessageException {
        ...
        if (msgParts[3].equals("YOU\n")) {
            board.setNextPlayerSide(mySide);
            moveTurn.again = true;
        } else if (msgParts[3].equals("OPP\n")) {
            board.setNextPlayerSide(mySide.opposite());
