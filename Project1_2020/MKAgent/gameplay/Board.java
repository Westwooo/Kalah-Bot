...
public class Board extends Observable implements Cloneable {
     ...
     * @see #board
     */
    public static final int NORTH_ROW = 0;
    /**
     * @see #board
     */
    public static final int SOUTH_ROW = 1;
    ...
    /**
     * The side of the player to play next.
     */
    private Side nextPlayerSide;
    ...
    public Board(Board original) {
        ...
        nextPlayerSide = original.nextPlayerSide;
    ...
    public Side getNextPlayerSide() {
        return nextPlayerSide;
    }

    public void setNextPlayerSide(Side nextPlayerSide) {
        this.nextPlayerSide = nextPlayerSide;
    }
    ...
    public boolean equals(Object o) {
        ...
        return Arrays.deepEquals(board, board1.board) && nextPlayerSide == board1.nextPlayerSide;
    }

    @Override
    public int hashCode() {
        int result = indexOfSide(nextPlayerSide);
